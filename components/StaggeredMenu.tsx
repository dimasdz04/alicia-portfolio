        ...
        >
          {(() => {
            ...
            return arr.map((c, i) => (
              <div
                key={i}
                className="sm-prelayer absolute top-0 right-0 h-full w-full translate-x-0 pointer-events-auto"
                style={{ background: c }}
              />
            ));
          })()}
...
.sm-scope .sm-prelayer { position: absolute; top: 0; right: 0; height: 100%; width: 100%; transform: translateX(0); pointer-events: auto; }
